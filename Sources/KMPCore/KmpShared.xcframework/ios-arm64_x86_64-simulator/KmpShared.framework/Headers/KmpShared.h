...
@class KmpSharedAPPUBLICONFIG;

@protocol KmpSharedPlatform;
...
@interface KmpSharedGreeting : KmpSharedBase
...
@interface KmpSharedIOSPlatform : KmpSharedBase <KmpSharedPlatform>
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
@property (readonly) NSString *name __attribute__((swift_name("name")));
@end
...
@interface KmpSharedAPPUBLICONFIG : KmpSharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)aPPUBLICONFIG __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) KmpSharedAPPUBLICONFIG *shared __attribute__((swift_name("shared")));
@property (readonly) NSString *NAME __attribute__((swift_name("NAME")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("Platform_iosKt")))
@interface KmpSharedPlatform_iosKt : KmpSharedBase
+ (id<KmpSharedPlatform>)getPlatform __attribute__((swift_name("getPlatform()")));
@end
